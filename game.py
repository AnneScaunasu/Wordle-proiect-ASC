...
for k in range(1,6):
    ok=0
    r=1
    print(f"\033[3;37;40m Introduceti cuvantul de 5 litere(de tipar) - {6-k+1} incercari ramase")
    while r==1:
        okk=0
        cuv1 = list(input())
        cuv1.append("\n")
    ...
    print()
    if ok==5:
        print("Ai gasit cuvantul!")
        break
if ok!=5:
    print(f"\033[3;31;40m Ai pierdut \nCuvantul era {''.join(CUVANT)}")
